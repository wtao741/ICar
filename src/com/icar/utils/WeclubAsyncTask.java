 ...
 * </ul>
 */
public abstract class WeclubAsyncTask<Params, Progress, Result> {
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new WeclubAsyncTaskResult<Result>(
									WeclubAsyncTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new WeclubAsyncTaskResult<Result>(WeclubAsyncTask.this,
								result));
				message.sendToTarget();
			}
		};
	 ...
	 */
	public final WeclubAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	...
	protected final void publishProgress(Progress... values) {
		sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
				new WeclubAsyncTaskResult<Progress>(this, values))
				.sendToTarget();
	}
	...
	private static class InternalHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			WeclubAsyncTaskResult result = (WeclubAsyncTaskResult) msg.obj;
			switch (msg.what) {
	...
	private static class WeclubAsyncTaskResult<Data> {
		final WeclubAsyncTask mTask;
		final Data[] mData;

		WeclubAsyncTaskResult(WeclubAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
