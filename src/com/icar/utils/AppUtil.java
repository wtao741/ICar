...
public class AppUtil {
	...
	// /*得到json所有关键字是key的值
	// * */
	// public static int[] getJsonObjectIntegerArray(JSONArray jsonArray, String
	// key) {
	// int res[];
	// try {
	...
	// }
	//
	// public static Bitmap resizeBitmap(Bitmap bitmap, float desWidth, float
	// desHeight) {
	// if (bitmap == null) {
	// return null;
	// }
	...
	// AppUtil.printLog("AppUtil", "Sorry, the file can not be created. " +
	// e.getMessage());
	// return null;
	// } catch (IOException e) {
	// AppUtil.printLog("AppUtil",
	// "IOException occurred when save upload file. " + e.getMessage());
	// return null;
	// }
	// }
	//
	...
	// }
	//
	// public static ProgressDialog showProgress(Activity activity, String
	// hintText) {
	// Activity mActivity = null;
	// if (activity.getParent() != null) {
	// mActivity = activity.getParent();
	...
	// }
	//
	// public static String getHtmlTemplate(Context context, String
	// assetsFileName) {
	// String html = "";
	// try {
